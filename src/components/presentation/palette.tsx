      ...
      <div className="h-full w-screen place-items-center bg-white px-8 py-8">
        <div className="container mx-auto grid items-center relative lg:grid-cols-2">
          <div className="hidden lg:flex">
            <img
              src="/astro-showcase/palette.png"
              alt="iphone"
          ...
          <div className="text-center lg:text-left">
            ...
            <Typography color="gray" className="lg:pr-20">
              Personalizamos los colores, logos e imagenes de diversos tamaños,
              espacioados, incluso la tipografía en minutos para que se ajusten
              perfectamente a la identidad de tu marca. Dedicando tiempo a crear
              herramientas que destacan.
            </Typography>
          </div>
        </div>
      </div>
