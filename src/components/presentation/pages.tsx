...
const posts = [
  ...
  },
  {
    ...
    title: "Dashboard",
    desc: "Está diseñado para brindarle al usuario toda la información que necesita para tomar una decisión de compra.",
    url: "/dashboard",
  },
  {
    img: "billing-page.jpg",
    title: "Página de facturación",
    desc: "Incluye un resumen de los artículos en el carrito y un formulario para información de facturación y envío.",
    url: "/billing",
  },
];
        ...
        <div className="container mx-auto px-8 py-10">
          <div className="mb-16 text-left">
            ...
            <Typography color="blue-gray">
              Comienza a mostrar tu página de comercio electrónico a sus
              clientes, completamente codificada e inspirada en el diseño de Tu
              Marca.
            </Typography>
          </div>
