        ...
        <div className="container mx-auto grid items-center relative lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <Typography color="blue-gray" className="lg:pr-20">
              Comerciar de forma electrónica le ahorrará mucho tiempo, ya que
              proporciona una base sólida para la venta en línea, lo que le
              permitirá a su equipo concentrarse en dar atención personalizada y
              agregar características específicas para satisfacer las
