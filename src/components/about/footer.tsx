...
const links2 = ["Terminos de uso", "Políticas de Privacidad", "Cookies"];
          ...
          <div className="flex flex-wrap items-end justify-center gap-8 md:justify-between">
            ...
            <div className="w-full sm:w-[24rem] sm:min-w-[24rem]">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Input color="black" label="Introduce tu correo electrónico" />
                <Button color="dark">subscribirse</Button>
              </div>
            </div>
          </div>
