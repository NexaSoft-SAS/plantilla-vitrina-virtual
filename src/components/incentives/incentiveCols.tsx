        ...
        <div className="col-12 col-md-4">
          <div className="card shadow-xs border">
            <div className="card-body p-3 d-flex">
              ...
              <div className="ms-3">
                <h5 className="mb-0">Envío express</h5>
                <p className="mb-0 opacity-8">¿Lo necesitas rápido? ¡No hay problema!</p>
              </div>
            </div>
          </div>
        </div>
        <div className="col-12 col-md-4 my-4 my-md-0">
          <div className="card shadow-xs border">
            <div className="card-body p-3 d-flex">
              ...
              <div className="ms-3">
                <h5 className="mb-0">Intercambios gratuitos</h5>
                <p className="mb-0 opacity-8">Lo reemplazaremos gratis</p>
              </div>
            </div>
          </div>
        </div>
        <div className="col-12 col-md-4">
          <div className="card shadow-xs border">
            <div className="card-body p-3 d-flex">
              ...
              <div className="ms-3">
                <h5 className="mb-0">Garantía extendida</h5>
                <p className="mb-0 opacity-8">Queremos que te sientas seguro</p>
              </div>
            </div>
          </div>         
        </div>
