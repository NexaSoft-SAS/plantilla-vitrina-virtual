...
export default function incentiveLarge({
  ...
  return (
    <>
     <div>
        <h2>Lo que tenemos para ofrecer</h2>
        <p className="pe-md-12 me-lg-12">Romper con las fronteras y limitaciones es posible.</p>
        <div className="row mt-5">
          <div className="col-12 col-md-4">
            <div className="card shadow-xs border p-3 p-md-4 mb-4">
              ...
              <h5>Envío express</h5>
              <p className="opacity-8">Ahora es el momento de ser grandioso y hacer de otros grandiosos.</p>
            </div>
          </div>
