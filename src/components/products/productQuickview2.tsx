          ...
          <div className="card card-product">
            <div className="card-body d-block d-lg-flex p-4">
              ...
              <div className="w-100 w-lg-50 text-center">
                ...
                <a className="text-body" href="#">Ver detalles</a>
              </div>
              <div className="w-100 w-lg-50 ps-4 text-center">
                ...
                <p className="text-center px-5">Mientras vivimos, nuestros corazones se vuelven más fríos. Porque el dolor es lo que pasamos a medida que envejecemos.</p>
                  ...
                  <div className="col-6">
                    <div className="form-check">
                      ...
                      <label className="cursor-pointer label-lg" htmlFor="18l">
                        <h6>2 Places</h6>
                        <p className="mb-0">Eso es lo que hago</p>
                      </label>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="form-check">
                      ...
                      <label className="cursor-pointer label-lg" htmlFor="20l">
                        <h6>4 Places</h6>
                        <p className="mb-0">Eso es para lo que estoy aquí</p>
                      </label>
                    </div>
                  </div>
                </div>

                <p className="mt-md-7 mb-4">¿Que deberia comprar?<span data-bs-toggle="tooltip" data-bs-placement="top" title="More information related to sizes" data-container="body" data-animation="true"><i className="fas fa-question-circle ms-1"></i></span></p>
              
                <div className="d-block text-center">
                  <button className="btn btn-dark btn-lg w-100">Agregar al carrito</button>
