      ...
      <div className="card card-product card-plain">
        ...
        <div className="row mt-5">
          <div className="col-12 col-lg-6">
            ...
            <p>
              No hay nada que realmente quisiera hacer en la vida en lo que no
              pude mejorar. Esa es mi habilidad. En realidad, no tengo ningún
              talento específico para nada excepto la capacidad de aprender. Eso
              es lo que hago. Eso es para lo que estoy aquí. No tengas miedo de
              equivocarte porque no puedes aprender nada de un cumplido.
            </p>
            {highlights.length != 0 && (
              <>
                <h6>Beneficios</h6>
