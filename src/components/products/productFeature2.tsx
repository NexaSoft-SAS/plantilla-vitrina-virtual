              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4 pe-lg-10">
                    ...
                    <p>
                      Si todo lo que hice fracasó (que no es así, en realidad
                      tuvo éxito), el solo hecho de que esté dispuesto a
                      fracasar es una inspiración. La gente tiene tanto miedo de
                      perder que ni siquiera lo intenta.
                      <br />
                      <br />
                      Una cosa que la gente no puede decir es que no lo estoy
                      intentando, y que no estoy haciendo lo mejor que puedo, y
                      que no estoy tratando de hacerlo de la mejor manera que
                      sé.
                    </p>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-6 mb-4">
                        <img
                          ...
                          src={`${import.meta.env.BASE_URL}/images/product10.jpg`}
                          alt=""
                        />
                      </div>
                      <div className="col-6 mb-4">
                        <img
                          className="w-100 rounded-3"
                          src={`${import.meta.env.BASE_URL}/images/product11.jpg`}
                          alt=""
                        />
                      </div>
                      <div className="col-6 mb-4">
                        <img
                          className="w-100 rounded-3"
                          src={`${import.meta.env.BASE_URL}/images/product12.jpg`}
                          alt=""
                        />
                      </div>
                      <div className="col-6">
                        <img
                          className="w-100 rounded-3"
                          src={`${import.meta.env.BASE_URL}/images/product13.jpg`}
                          alt=""
                        />
                      </div>
                    </div>
              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    ...
                    <p>
                      Ahora es el momento de ser grandioso y hacer de otros Por
                      ser un color brillante. Por destacar. Pero ahora es el
                      momento de estar bien y ser el mejor tú.
                      <br />
                      <br />
              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    ...
                    <p>
                      Siempre sentí que podía hacer cualquier cosa. ¡Eso es lo
                      principal que controla a la gente! Pensamientos: ¡su
                      percepción de sí mismos! They're slowed down by their
                ...
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    ...
                    <p>
                      ...
                      errores. Estamos constantemente tratando de expresarnos y
                      hacer realidad nuestros sueños.
                      <br />
                      <br />
                      Si tienes la oportunidad de jugar este juego de la vida,
                      debes apreciar cada momento. Mucha gente no aprecia el
                      momento hasta que pasa.
                    </p>
                  </div>
