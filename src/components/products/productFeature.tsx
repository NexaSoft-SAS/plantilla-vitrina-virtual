        ...
        <div className="row mt-5">
          <div className="col-12 col-lg-6 pe-5">
            <div className="row">
              ...
              <p className="mb-5">
                Romper con las fronteras y limitaciones es posible. Es como un
                niño pequeño, un niño pequeño, que mira los colores y nadie le
                dice qué colores son buenos, antes de que alguien te diga que no
                te debería gustar el rosa porque es para niñas, o
                instantáneamente te convertirías en gay a los dos años. -viejo.
              </p>
