        ...
        <div className="d-block d-md-flex justify-content-between align-items-center">
          <div className="d-block d-md-flex">
            <div className="d-flex d-md-block justify-content-between p-4 me-md-4">
              <p className="text-sm mb-0">Orden Id</p>
            ...
            <div className="d-flex d-md-block justify-content-between p-4">
              <p className="text-sm mb-0">Valor</p>
              <h6>$2,570</h6>
            </div>
          </div>
          <button className="btn btn-dark btn-sm mb-md-0 ms-4 md-md-0 me-4" data-bs-toggle="modal" data-bs-target="#invoiceModal1">Mirar la factura</button>
              ...
              <div className="modal-content">
                      ...
                      <div className="row justify-content-md-between">
                        ...
                        <div className="col-lg-4 col-md-5">
                          <div className="d-flex align-items-center mt-5 ms-auto float-end">
                            <div className="text-sm me-3 font-weight-bold">Fecha de la factura:</div>
                        ...
                        <table className="table text-right">
                          <thead className="bg-default">
                            <tr>
                              ...
                              <th scope="col" className="text-right text-white">Valor</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                ...
                <div className="card-footer text-right">
                  <div className="col-md-5 ms-auto text-end">
                    ...
                    <h6 className="mb-0">
                      correo electrónico:
                      <small className="text-muted"> nexasoftprofessionalsolutions@gmail.com</small>
                    </h6>
                  </div>
                </div>
                </div>
        ...
        <table className="table">
          <thead>
            <tr>
              ...
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2">Estado</th>
