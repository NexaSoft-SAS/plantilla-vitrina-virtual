    ...
    <div className="p-3 p-md-5 bg-gray-100 rounded-2">
      <div className="d-block d-md-flex justify-content-between align-items-center mb-4"> 
        <div className="d-block">
          ...
          <p className="mb-0 text-dark mt-4 mt-md-0">Pedido realizado <b>{order.date}</b></p>
        </div>
        <button className="btn btn-dark btn-sm">Mirar la factura</button>
      </div>
      ...
      <div className="card shadow-xs border p-3 p-md-4 mb-4">
        <div className="row">
          ...
          <div className="col-12 col-lg-3 mt-4 mt-lg-0">
            <h5 className="text-base">Información del pago</h5>
            <div className="d-flex">
              ...
              <p className="text-sm ms-3">
                ...
                <small>Vencimiento {order.payment.expiringDate}</small>
              </p>
            </div>
          </div>
