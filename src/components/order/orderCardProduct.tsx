      ...
      <div className="card shadow-xs border p-3 p-md-4 mb-4">
        ...
        <div className="mt-4">
          <h6 className="text-center">
            Preparándose para enviar el 24 de marzo, 2024
          </h6>
          ...
          <div className="d-block d-md-flex justify-content-between">
            <div className="d-block text-center">
              ...
              <p className="font-weight-semibold text-dark">Pedido realizado</p>
            </div>
            {status == "Pedido realizado" && (
              <>
                <div className="d-block text-center">
                  ...
                  <p className="font-weight-semibold">Procesado</p>
                </div>
                <div className="d-block text-center">
                  <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                    <svg
                  ...
                  <p className="font-weight-semibold">Embarcado</p>
                </div>
                <div className="d-block text-center">
                  <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                    <svg
            ...
            {status == "Embarcado" && (
              <>
                ...
                <div className="d-block text-center">
                  ...
                  <p className="font-weight-semibold text-dark">Embarcado</p>
                </div>
                <div className="d-block text-center">
                  <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                    <svg
