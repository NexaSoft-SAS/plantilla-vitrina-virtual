      ...
      <section>
            ...
            <div className="row justify-content-center">
              <div className="col-sm-9 text-center mx-auto pt-6">
                ...
                <p className="lead mb-sm-5 px-md-8">
                  Ahora es el momento de ser grandioso y hacer de otros Por ser
                  un color brillante. Por destacar. Pero ahora es el momento de
                  estar bien y ser el mejor tú.
                </p>
        ...
        <div className="container">
          ...
          <p className="mb-5 w-60">
            Romper con las fronteras y limitaciones es posible.
          </p>
          <div className="row">
              ...
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  ...
                  <p className="mt-4">
                    ...
                    hacer realidad nuestros sueños. Si tienes la oportunidad de
                    jugar este juego de la vida, debes apreciar cada momento.
                  </p>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  <Reviews rating={5} />
                  <p className="mt-4">
                    No hay nada que realmente quisiera hacer en la vida en lo
                    que no pude mejorar. Esa es mi habilidad. En realidad, no
                    tengo ningún talento específico para nada excepto la
                    capacidad de aprender. Eso es lo que hago. Eso es para lo
                    que estoy aquí. No tengas miedo de equivocarte porque no
                    puedes aprender nada de un cumplido.
                  </p>
                  <div className="d-flex align-items-center">
                    <div className="avatar avatar-sm position-relative me-2">
                      <img
            ...
            <div className="col-12 col-md-12 col-lg-4">
              <div className="card border shadow-xs mb-4">
                <div className="card-body text-start p-3 w-100">
                  <Reviews rating={4} />
                  <p className="mt-4">
                    Realmente importa y luego realmente no importa. Lo que
                    importa son las personas que se sienten estimuladas por
                    ello. Y a la gente que se siente ofendida por ello, no
                    importa. Porque se trata de motivar a los hacedores. Porque
                    estoy aquí para seguir mis sueños e inspirar a otras
                    personas a seguir los suyos.
                  </p>
                  <div className="d-flex align-items-center">
                    <div className="avatar avatar-sm position-relative me-2">
                      <img
