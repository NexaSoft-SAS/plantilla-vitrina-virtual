      ...
      <div className="col-12 col-lg-5">
        <div className="p-4 mb-4">
          ...
          <div className="d-flex align-items-center">
            ...
            <p className="mb-0 ms-2">Basado en <b>{reviews.length}</b> reseñas</p> 
          </div>
          <div className="mt-4 mb-5">
            <ReviewProgress reviews={reviews}/>
          </div>
          <h5>Valoramos su opinión</h5>
          <p className="mb-5">Ahora es el momento de ser grandioso y hacer de otros grandiosos.</p>
          <button className="btn btn-dark w-100 mb-0">Escribe una reseña</button>
        </div>
      </div>
